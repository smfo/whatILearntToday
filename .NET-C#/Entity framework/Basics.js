...
// Migrations
// This feature provices a way to update the database schema to keep it in sync with the application's data while preserving existing
// data in the database
// the migration scripts are kept in order to keep track of the database versions
// Add a migration to bring the database schemas up to data with the EF Core Model. The migration nae can be used as a commit message,
